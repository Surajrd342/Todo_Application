...
public class TodoListFragment extends Fragment {
    View rootView;
    private TodoViewModel mnTodoViewModel;
    ...
    void updateRV(){
        mnTodoViewModel.getAllTodos().observe(this, new Observer<List<ETodo>>() {
            @Override
        ...
        public TodoHolder(LayoutInflater inflater, ViewGroup parentViewGroup) {
            ...
            mTitle.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    TodoAdapter adapter = new TodoAdapter(mnTodoViewModel.getAllTodos().getValue());
