...
public class EditTodoFragment extends Fragment {
    ...
    void DisplayAlerDialog(){
        mnAlterDialog = new AlertDialog.Builder(getContext());
        mnAlterDialog.setMessage(getString(R.string.edit_cancel_promt))
                .setCancelable(false)
    ...
    void DispalyTodoDate(){
        ...
        mnDatePicker =new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
            @Override
